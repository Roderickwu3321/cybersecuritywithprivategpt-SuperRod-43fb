[cybersecuritywithprivategpt-SuperRod-43fb] Operating Details
====================================

Generated On: 2024-11-19 19:34:58 UTC
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-SuperRod-43fb] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-SuperRod-43fb] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Roderickwu3321/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Roderickwu3321/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39291  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Roderickwu3321'  \-\-env DOCKERUSERNAME='roderickwu'  \-\-env MQTTUSERNAME='roderickwu'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   roderickwu/cybersecuritywithprivategpt-SuperRod-43fb-amd64 (https://hub.docker.com/r/roderickwu/cybersecuritywithprivategpt-SuperRod-43fb-amd64)
...
.. important::
   docker run -d -p 52563:52563 -p 54517:54517 -p 54581:54581 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-SuperRod-43fb \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-SuperRod-43fb \-\-env GITUSERNAME=Roderickwu3321  \-\-env GITREPOURL=https://github.com/Roderickwu3321/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=52563  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=54517  \-\-env SOLUTIONVIPERVIZPORT=54581 \-\-env DOCKERUSERNAME='roderickwu' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=39291 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='roderickwu' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  roderickwu/cybersecuritywithprivategpt-SuperRod-43fb-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - roderickwu/cybersecuritywithprivategpt-SuperRod-43fb-amd64
...
[cybersecuritywithprivategpt-SuperRod-43fb] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Roderickwu3321/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-SuperRod-43fb
...
.. important::
   https://cybersecuritywithprivategpt-SuperRod-43fb.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-SuperRod-43fb
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=52563, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=41195, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46623, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42825, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33269, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46221, HPDEHOST=127.0.1.1, HPDEPORT=40447, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37415

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6584-cybersecuritywithprivategpt-SuperRod-43fb,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-SuperRod-43fb, python-preprocess-5039-cybersecuritywithprivategpt-SuperRod-43fb,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-SuperRod-43fb, python-ai-39-cybersecuritywithprivategpt-SuperRod-43fb,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-SuperRod-43fb, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
